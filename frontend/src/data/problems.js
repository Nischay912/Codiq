...
class Solution {
    ...
    void printVec(std::vector<char>& s) {
        std::cout << "[";
...
print(isPalindrome(" "))  # Expected: True`,
    ...
    int main() {
        ...
        std::cout << (isPalindrome("race a car") ? "true" : "false") << std::endl;
...
print(maxSubArray([5,4,-1,7,8]))  # Expected: 23`,
    ...
    int main() {
        ...
        std::cout << maxSubArray(n1) << std::endl;

        std::vector<int> n2 = {1};
        std::cout << maxSubArray(n2) << std::endl;

        std::vector<int> n3 = {5,4,-1,7,8};
        std::cout << maxSubArray(n3) << std::endl;
        return 0;
}`,
    },
    expectedOutput: {
...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  "trapping-rain-water": {
    ...
    description: {
      ...
      notes: [
        "The elevation map is represented by the array height.",
...
int main() {
    ...
    std::cout << trap(h1) << std::endl;

    std::vector<int> h2 = {4,2,0,3,2,5};
    std::cout << trap(h2) << std::endl;
    return 0;
}`,
    },
    expectedOutput: {
